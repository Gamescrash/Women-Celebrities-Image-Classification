...
def get_cropped_image_if_2_eyes(image_path, image_base64_data):
    ...
    face_cascade_path = model_dir / 'opencv' / 'haarcascades' / 'haarcascade_frontalface_default.xml'
    eyes_cascade_path = model_dir / 'opencv' / 'haarcascades' / 'haarcascade_eye.xml'
